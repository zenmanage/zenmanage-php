...
final class ApiClientTest extends TestCase
{
    ...
    public function testClientHeadersUseZenApiKeyPrefix(): void
    {
    ...
    public function testGetRulesRejectsNonHttpsCdnUrl(): void
    {
        ...
        /** @var \Mockery\Expectation $get */
        $get = $httpClient->shouldReceive('get');
        $get->times(1)->with('/v1/flag-json')->andReturn(new Response(200, [], json_encode([
    ...
    public function testReportUsageUrlEncodesFlagKey(): void
    {
        ...
        /** @var \Mockery\Expectation $post */
        $post = $httpClient->shouldReceive('post');
        $post->once()->with('/v1/flags/flag%2Fwith%2Fslashes/usage', Mockery::any())->andReturn(new Response(200));
